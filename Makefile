...
EXPANDER_SRC = $(addprefix $(SRC_DIR)expander/, expander.c double_quotes.c utils.c question_mark.c)
EXECUTOR_SRC = $(addprefix $(SRC_DIR)executor/, executor.c echo.c pwd.c env.c)
